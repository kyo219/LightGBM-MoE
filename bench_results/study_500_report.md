...
|---|---|---|---|---|---|
| synthetic | naive-lightgbm | 5.0233 | 5.3109 | 0.034 | 88 |
| synthetic | moe | 3.6779 | 4.4032 | 0.044 | 134 |
| fred_gdp | naive-lightgbm | 0.9311 | 0.9442 | 0.003 | 14 |
| fred_gdp | moe | 0.9381 | 0.9876 | 0.020 | 66 |
| sp500_basic | naive-lightgbm | 0.0100 | 0.0100 | 0.012 | 37 |
| sp500_basic | moe | 0.0100 | 0.0100 | 0.119 | 298 |
| sp500 | naive-lightgbm | 0.0100 | 0.0101 | 0.009 | 30 |
| sp500 | moe | 0.0100 | 0.0101 | 0.054 | 169 |
| vix | naive-lightgbm | 2.8869 | 2.9655 | 0.011 | 34 |
| vix | moe | 2.6745 | 2.7824 | 0.062 | 175 |
| hmm | naive-lightgbm | 2.1913 | 2.2029 | 0.005 | 21 |
| hmm | moe | 2.1465 | 2.2111 | 0.046 | 127 |
...
- train: median 0.034s/fold, mean 0.032s, p90 0.050s
...
| param | importance |
|---|---|
| `mixture_gate_type` | 0.642 |
| `mixture_hard_m_step` | 0.099 |
| `mixture_routing_mode` | 0.096 |
...
| param | importance |
|---|---|
| `min_data_in_leaf` | 0.710 |
| `feature_fraction` | 0.102 |
| `bagging_fraction` | 0.053 |
| `learning_rate` | 0.052 |
| `bagging_freq` | 0.050 |
| `num_leaves` | 0.019 |
| `max_depth` | 0.010 |
...
| `feature_fraction` | 0.9471 | 0.9454 | 0.9458 | 0.9487 | **Q2** [0.8076, 0.8371] |
| `bagging_fraction` | 0.9475 | 0.9439 | 0.9460 | 0.9496 | **Q2** [0.6277, 0.6542] |
...
- best RMSE: **0.9381**, median: 0.9876, p10: 0.9528
- train: median 0.020s/fold, mean 0.021s, p90 0.029s
- finite trials: 500 / 500
...
| gbdt | 57 | 1.0061 | 0.0516 | 0.9507 |
| none | 32 | 1.0146 | 0.0677 | 0.9505 |

**`mixture_routing_mode`**
| value | n | mean RMSE | std | min |
|---|---|---|---|---|
| expert_choice | 451 | 0.9977 | 0.0450 | 0.9381 |
...
| loss_only | 251 | 0.9990 | 0.0476 | 0.9381 |
| em | 25 | 1.0253 | 0.0625 | 0.9588 |

**`mixture_init`**
| value | n | mean RMSE | std | min |
|---|---|---|---|---|
| random | 395 | 0.9951 | 0.0450 | 0.9381 |
...
| none | 56 | 1.0067 | 0.0522 | 0.9381 |
| markov | 37 | 1.0175 | 0.0632 | 0.9420 |

**`mixture_hard_m_step`**
| value | n | mean RMSE | std | min |
|---|---|---|---|---|
| False | 469 | 0.9968 | 0.0437 | 0.9381 |
| True | 31 | 1.0360 | 0.0723 | 0.9577 |

**`extra_trees`**
| value | n | mean RMSE | std | min |
|---|---|---|---|---|
| True | 166 | 0.9967 | 0.0515 | 0.9454 |
...
| param | Q1 | Q2 | Q3 | Q4 | best Q (range) |
|---|---|---|---|---|---|
| `mixture_num_experts` | 1.0237 | — | — | 0.9972 | **Q4** [4.0, ∞) |
| `mixture_e_step_alpha` | 1.0068 | 0.9965 | 0.9938 | 0.9996 | **Q3** [2.3734, 2.5232] |
| `mixture_diversity_lambda` | 0.9926 | 0.9969 | 1.0003 | 1.0070 | **Q1** [None, 0.0418] |
| `mixture_warmup_iters` | 0.9995 | 0.9914 | 1.0015 | 1.0031 | **Q2** [13.0, 16.0] |
| `mixture_balance_factor` | 0.9958 | — | 0.9968 | 1.0057 | **Q1** [None, 5.0] |
| `learning_rate` | 1.0053 | 0.9995 | 0.9982 | 0.9938 | **Q4** [0.1149, ∞) |
| `num_leaves` | 0.9970 | 0.9974 | 0.9969 | 1.0053 | **Q3** [20.0, 37.0] |
| `max_depth` | 1.0015 | 0.9948 | — | 1.0002 | **Q2** [9.0, 10.0] |
| `min_data_in_leaf` | 0.9779 | 0.9716 | 0.9941 | 1.0468 | **Q2** [25.0, 28.0] |
...
- best RMSE: **0.0100**, median: 0.0100, p10: 0.0100
- train: median 0.119s/fold, mean 0.113s, p90 0.152s
- finite trials: 500 / 500
...
|---|---|
| `mixture_init` | 0.283 |
| `min_data_in_leaf` | 0.232 |
| `learning_rate` | 0.123 |
| `mixture_r_smoothing` | 0.065 |
| `mixture_warmup_iters` | 0.059 |
| `num_leaves` | 0.036 |
| `mixture_diversity_lambda` | 0.033 |
| `mixture_gate_type` | 0.024 |
...
| param | best | mean RMSE | runner-up | Δ | p |
|---|---|---|---|---|---|
| `mixture_gate_type` | **gbdt** | 0.0100 (n=403) | leaf_reuse | Δ +0.0001 | p=8.70e-05 |
| `mixture_routing_mode` | **expert_choice** | 0.0100 (n=453) | token_choice | Δ +0.0001 | p=0.00e+00 |
| `mixture_e_step_mode` | **em** | 0.0100 (n=376) | loss_only | Δ +0.0001 | p=7.47e-04 |
| `mixture_init` | **gmm** | 0.0100 (n=433) | random | Δ +0.0001 | p=0.00e+00 |
| `mixture_r_smoothing` | **none** | 0.0100 (n=424) | ema | Δ +0.0001 | p=1.70e-05 |
...
| value | n | mean RMSE | std | min |
|---|---|---|---|---|
| gbdt | 403 | 0.0100 | 0.0000 | 0.0100 |
| leaf_reuse | 72 | 0.0101 | 0.0000 | 0.0100 |
| none | 25 | 0.0101 | 0.0000 | 0.0100 |
...
| value | n | mean RMSE | std | min |
|---|---|---|---|---|
| em | 376 | 0.0100 | 0.0000 | 0.0100 |
| loss_only | 64 | 0.0101 | 0.0000 | 0.0100 |
| gate_only | 60 | 0.0101 | 0.0000 | 0.0100 |
...
| tree_hierarchical | 25 | 0.0101 | 0.0000 | 0.0100 |

**`mixture_r_smoothing`**
| value | n | mean RMSE | std | min |
|---|---|---|---|---|
| none | 424 | 0.0100 | 0.0000 | 0.0100 |
| ema | 45 | 0.0101 | 0.0000 | 0.0100 |
| markov | 31 | 0.0101 | 0.0000 | 0.0100 |
...
| `mixture_e_step_alpha` | 0.0101 | 0.0100 | 0.0100 | 0.0100 | **Q2** [1.5411, 1.6775] |
| `mixture_diversity_lambda` | 0.0100 | 0.0100 | 0.0100 | 0.0101 | **Q1** [None, 0.1493] |
| `mixture_warmup_iters` | 0.0100 | 0.0100 | 0.0100 | 0.0100 | **Q1** [None, 23.0] |
| `mixture_balance_factor` | 0.0100 | 0.0100 | — | 0.0100 | **Q1** [None, 7.0] |
| `learning_rate` | 0.0100 | 0.0100 | 0.0100 | 0.0101 | **Q1** [None, 0.0152] |
| `num_leaves` | 0.0100 | 0.0100 | 0.0100 | 0.0100 | **Q1** [None, 51.0] |
| `max_depth` | 0.0100 | — | 0.0100 | 0.0100 | **Q1** [None, 6.0] |
| `min_data_in_leaf` | 0.0100 | 0.0100 | 0.0100 | 0.0101 | **Q1** [None, 7.0] |
...
- train: median 0.054s/fold, mean 0.062s, p90 0.092s
- finite trials: 500 / 500
...
| param | importance |
|---|---|
| `mixture_r_smoothing` | 0.213 |
| `mixture_diversity_lambda` | 0.187 |
| `learning_rate` | 0.131 |
| `bagging_fraction` | 0.121 |
| `num_leaves` | 0.070 |
| `min_data_in_leaf` | 0.044 |
| `mixture_gate_type` | 0.042 |
| `mixture_init` | 0.040 |
| `mixture_warmup_iters` | 0.035 |
| `mixture_e_step_alpha` | 0.028 |
...
- train: median 0.011s/fold, mean 0.011s, p90 0.015s
- finite trials: 500 / 500
...
| `mixture_init` | 0.332 |
| `learning_rate` | 0.169 |
| `mixture_warmup_iters` | 0.117 |
| `mixture_gate_type` | 0.096 |
| `num_leaves` | 0.053 |
| `mixture_e_step_alpha` | 0.051 |
| `min_data_in_leaf` | 0.034 |
| `feature_fraction` | 0.024 |
| `mixture_r_smoothing` | 0.023 |
| `lambda_l2` | 0.017 |
...
- train: median 0.046s/fold, mean 0.045s, p90 0.058s
- finite trials: 500 / 500
...
| param | importance |
|---|---|
| `min_data_in_leaf` | 0.278 |
| `bagging_freq` | 0.134 |
| `lambda_l1` | 0.114 |
| `mixture_warmup_iters` | 0.096 |
| `mixture_e_step_mode` | 0.066 |
| `mixture_e_step_alpha` | 0.051 |
| `mixture_diversity_lambda` | 0.044 |
| `learning_rate` | 0.041 |
| `mixture_gate_type` | 0.037 |
| `max_depth` | 0.027 |
...
| sp500_basic | `mixture_gate_type` | **gbdt** | +0.0001 | 8.70e-05 |
| sp500_basic | `mixture_routing_mode` | **expert_choice** | +0.0001 | 0.00e+00 |
| sp500_basic | `mixture_e_step_mode` | **em** | +0.0001 | 7.47e-04 |
| sp500_basic | `mixture_init` | **gmm** | +0.0001 | 0.00e+00 |
| sp500_basic | `mixture_r_smoothing` | **none** | +0.0001 | 1.70e-05 |
